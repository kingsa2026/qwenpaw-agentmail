...
(function() {
  ...
  // 邮件管理页面
  function EmailPage() {
    var _React$useState = React.useState("inbox");
        ...
        render: function(_, record) {
          return React.createElement(Space, { size: "middle" },
            React.createElement(Button, { 
              type: "link", 
              size: "small",
              onClick: function() { console.log("查看邮件:", record.id); }
            }, "查看"),
            React.createElement(Button, { 
              type: "link", 
              danger: true,
              size: "small",
              onClick: function() { console.log("删除邮件:", record.id); }
            }, "删除")
          );
        }
      }
    ...
    function InboxTab() {
      return React.createElement("div", null,
        React.createElement("div", { 
          ...
          React.createElement(Space, null,
            ...
            React.createElement(Button, { 
              ...
              onClick: function() { console.log("写邮件"); }
            }, "写邮件")
          ),
          React.createElement(Button, { 
            onClick: function() { console.log("标记全部已读"); }
          }, "标记全部已读")
        ),
        React.createElement(Table, {
          ...
          rowKey: "id",
          locale: { emptyText: React.createElement(Empty, { description: "暂无邮件" }) }
        })
      );
    }
    ...
    function ConfigTab() {
      return React.createElement("div", null,
        React.createElement(Card, { title: "邮箱配置", style: { marginBottom: 16 } },
          ...
          React.createElement("div", { style: { display: "flex", gap: 16, marginTop: 16 } },
            React.createElement(Card, {
              ...
              onClick: function() { console.log("传统邮箱配置"); }
            },
              React.createElement("div", { style: { fontSize: 32 } }, "📮"),
              React.createElement("p", { style: { marginTop: 8 } }, "传统邮箱"),
              React.createElement(Text, { type: "secondary", style: { fontSize: 12 } }, "POP3/IMAP/SMTP")
            ),
            React.createElement(Card, {
              hoverable: true,
              style: { width: 200, textAlign: "center", cursor: "pointer" },
              onClick: function() { console.log("AgentMail.to 配置"); }
            },
              React.createElement("div", { style: { fontSize: 32 } }, "🤖"),
              React.createElement("p", { style: { marginTop: 8 } }, "AgentMail.to"),
              React.createElement(Text, { type: "secondary", style: { fontSize: 12 } }, "AI 专用邮箱")
            ),
            React.createElement(Card, {
              hoverable: true,
              style: { width: 200, textAlign: "center", cursor: "pointer" },
              onClick: function() { console.log("混合模式配置"); }
            },
              React.createElement("div", { style: { fontSize: 32 } }, "🔀"),
              React.createElement("p", { style: { marginTop: 8 } }, "混合模式"),
              React.createElement(Text, { type: "secondary", style: { fontSize: 12 } }, "传统 + AgentMail")
            )
          )
        ),
        React.createElement(Card, { title: "当前配置" },
          ...
          React.createElement("p", null, 
            "状态: ", 
            React.createElement(Badge, { status: "default", text: "未连接" })
          )
        )
      );
    }
    ...
    return React.createElement("div", { style: { padding: "24px" } },
      React.createElement(Title, { level: 2, style: { marginBottom: 24 } }, 
